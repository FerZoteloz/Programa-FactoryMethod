...
public class Sandia extends JLabel implements Fruta {

    private int posX, posY;

    /**
     * Contructor de Frutas.Sandia que sirve para inicializar
     * los valores de las posiciones
     * @param posX para indicar la posicion del eje X
     * @param posY para indicar la posicion del eje Y
     */
    public  Sandia(int posX, int posY){
        this.posX = posX;

        this.posY = posY;
        setIcon(Imagenes.cargarImagenEscalada("/Imagenes/Sandia.png", 100,100));
    ...
    /**
     * Metodo que acualiza cordenadas del programa
     * @param posX para indicar nueva posicionX
     * @param posY para indicar nueva posicionY
     */
    @Override
    ...
    /**
     * Metodo que simula la caida de la sandia\
