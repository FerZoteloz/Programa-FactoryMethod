...
public class Manzana extends JLabel implements Fruta {

    private  int posX, posY;


    /**
     * Contructor de Frutas.Manzana que sirve para inicializar
    ...
    public  Manzana(int posX, int posY){
        this.posX = posX;
        this.posY = posY;
        this.setIcon(Imagenes.cargarImagenEscalada("/Imagenes/manzana.png",50,50));
    ...
    /**
     * Metodo que simula la caida de la manzana\
